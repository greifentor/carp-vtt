package de.ollie.carp.vtt.restserver.core.service.port.outbox;
...
public interface BattleMapOutboxPort {
	/**
	 * Called by the service after a battle map has been passed to the persistence port for saving.
	 *
